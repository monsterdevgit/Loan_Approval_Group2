...
applicant_income = st.sidebar.number_input("Applicant Income (₦)", min_value=0, max_value=1000000, value=5000)
coapplicant_income = st.sidebar.number_input("Coapplicant Income (₦)", min_value=0, max_value=500000, value=2000)
